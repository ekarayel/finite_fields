...
\title{Classification of Finite Fields}
\author{Emin Karayel}
\maketitle

\abstract{This entry formalizes the classification of the finite fields:
...
\]
The proofs are based on the books from Ireland and Rosen~\cite[\textsection 7]{ireland1982}, as well as,
